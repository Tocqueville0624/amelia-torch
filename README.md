...
Windows, macOS and Linux hosted CPU checks passed at `8b5ede9`, each with 262 Python tests, nine R test files and the downstream example. Intel Mac separately passed a reference-only wheel installation without Torch. The record identifies platform-specific branch coverage and explicitly excludes GPU validation. [CI evidence](docs/validation/2026-09-26-ci/cross-platform-ci-8b5ede9.md).
